        ...
        <Container>
          <Content>
            ...
            <ShaereCreation>
              ...
              <ShareComment>
                <AssetButton>
                  <img src="/images/anyone-comment.svg" alt="" />
                  Anyone
                </AssetButton>
              </ShareComment>
...
const ShaereCreation = styled.div`
  display: flex;
  justify-content: space-between;
...
const PostButton = styled.button`
  ...
  color: ${(props) => (props.disabled ? "#ffffffa9" : "white")};
  &:hover {
...
export default connect(mapToStateProps, mapDispatchToProps)(PostModal);
